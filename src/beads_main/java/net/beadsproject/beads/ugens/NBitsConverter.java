...
/**
 * Converts a signal to have n-bits, useful for 8-bit synthesis. PRE: Signal
 * must be in (-1,1) range POST: Signal is in (-1,1) range
 *
 * @author ben
 *
 */
public class NBitsConverter extends UGen {
    ...
    /**
     * Creates a new NBitsConverter with the specified {@link AudioContext} and
    ...
    /**
     * Creates a new NBitsConverter with the default {@link AudioContext} and number
     * of bits to convert to.
     * 
     * @param n the number of bits to convert to.
     */
