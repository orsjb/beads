...
public class ZMap extends UGen implements DataBeadReceiver {
    ...
    /**
     * Constructor for a 1-channel mapping object with default parameters (mapping
     * [0,1] to [0,1] with no clipping, or multiplying by 1 and adding 0).
     * 
    ...
    /**
     * Constructor for a mapping object with the specified number of channels and
     * the default parameters (mapping [0,1] to [0,1] with no clipping, or
    ...
    /**
     * Returns ZMap to its default setting: multiply by 1, add 0 (mapping [0,1] to
     * [0,1] with no clipping).
     * 
     * @return This ZMap instance.
     */
    public ZMap clear() {
    ...
    /**
     * Gets the value that is added to the signal after it has been multiplied by
     * the multiplier.
     * 
    ...
    /**
     * Specifies whether ZMap clips the incoming values to lie within the specified
     * range.
     * 
    ...
    public DataBeadReceiver sendData(DataBead db) {
        if (db != null) {
            setRanges(db.getFloat("sourceMinimum", o1), db.getFloat("sourceMaximum", o2),
                    db.getFloat("targetMinimum", n1), db.getFloat("targetMaximum", n2));
            multiplyThenAdd(db.getFloat("multiplier", a), db.getFloat("shift", b));
