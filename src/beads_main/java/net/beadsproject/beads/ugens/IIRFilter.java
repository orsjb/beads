...
public abstract class IIRFilter extends UGen {
     ...
     * delay, group delay.
     * 
     * @param bs           The b coefficients (corresponding to the x(n) terms of
     *                     the filter algorithm.
     * @param as           The a coefficients (corresponding to the y(n) terms of
     *                     the filter algorithm.
     * @param freq         The frequency to evaluate.
    ...
    public static class IIRFilterAnalysis {
        public double frReal = 0, frImag = 0, amplitudeResponse = 0, phaseResponse = 0, phaseDelay = 0, groupDelay = 0,
                w = 0;
    }
