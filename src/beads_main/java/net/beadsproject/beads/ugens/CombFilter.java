...
public class CombFilter extends IIRFilter {
    ...
    private boolean isAStatic, isGStatic, isHStatic, isDelayStatic, areAllStatic;
    private float[] xn, yn;
    ...
    /**
     * Sets the delay time in samples. This will remove the delay UGen, if there is
     * one.
     * 
    ...
    /**
     * Sets the g parameter to a float value. This will remove the g UGen, if there
     * is one.
     * 
    ...
    /**
     * Sets a UGen to specify the g parameter. Passing a null value will freeze the
    ...
    /**
     * Sets the h parameter to a float value. This will remove the h UGen, if there
     * is one.
     * 
    ...
    /**
     * Sets a UGen to specify the h parameter. Passing a null value will freeze the
     * parameter at its current value.
     * 
     * @param h The h UGen.
     * @return This CombFilter instance.
    ...
    /**
     * Sets the 'a' parameter to a float value. This will remove the 'a' UGen, if
     * there is one.
     * 
    ...
    /**
     * Sets a UGen to specify the 'a' parameter. Passing a null value will freeze
    ...
    /**
     * Sets the parameter UGens. Passing null values will freeze the parameters at
     ...
     * comparing the speed of this ParamUpdater // with Static AudioContext ac = new
     * AudioContext(); for (int i = 0; i < 1000; i++) { CombFilter c = new
     * CombFilter(ac, 1000);
     * 
