...
/**
 * 
 * Simple UGen that ramps between given values over a given duration (e.g., for
 * portamento).
 *
 * @author ollie
 */
public class Glide extends UGen {
    ...
    /**
     * Creates a new Glide with the specified AudioContext, initial value and glide
    ...
    /**
     * Creates a new Glide with the default AudioContext, initial value and glide
     * time in milliseconds.
     * 
     * @param currentValue the initial value.
     * @param glideTimeMS  the glide time in milliseconds.
    ...
    /**
     * Creates a new Glide with the specified AudioContext. Uses the default inital
     * value of zero and glide time of 100 milliseconds.
     * 
     * @param context the AudioContext.
     */
    ...
    /**
     * Creates a new Glide with the default AudioContext. Uses the default inital
     * value of zero and glide time of 100 milliseconds.
     */
    public Glide() {
    ...
    /**
     * Sets the target glide value. From its current value Glide immediately
     * interpolates its way to that value over the specified glideTime.
     * 
