...
/**
 * Function is an abstract class which can be quickly subclassed to make a
 * custom {@link UGen} on the fly. Subclasses of Function must implement
 * {@link #calculate()}, getting data from the array {@link #x}, and returning
 * the result. {@link #x} provides access to the array of {@link UGen}s that are
 * passed to Function's constructor.
 *
 * @author ollie
 */
public abstract class Function extends UGen {
    ...
    /**
     * Override this to calculate what to do. Use x[] to get the values from the
     * input {@link UGen}s.
     * 
