...
public class WavePlayer extends UGen {
    ...
    /**
     * Sets a UGen to control the frequency. Note that if the phase envelope is not
     * null, the frequency controller will have no effect.
     * 
...
//			frequency = frequencyUGen.getValue();	//Ollie - this is causing trouble. Shouldn't call update() except in the call chain.
    ...
    /**
     * Sets the frequency to a static value. Note that if the phase envelope is not
     * null, the frequency will have no effect.
     * 
