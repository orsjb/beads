...
/**
 * Static represents a {@link UGen} with a fixed value. Since the value is
 * fixed, Static doesn't actually calculate anything, and overrides the methods
 * {@link #getValue()} and {@link #getValue(int, int)} to return its fixed
 * value.
 *
 * @author ollie
 */
