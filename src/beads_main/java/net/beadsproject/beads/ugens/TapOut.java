...
public class TapOut extends UGen {
    ...
    /**
     * Constructor for a given TapIn object with a static float delay. The mode is
     * set to the default (no interpolation).
     * 
     ...
     * The mode is set to the default (no interpolation).
     * 
     * @param ac        The audio context.
     * @param ti        The TapIn from which to draw the delayed signal.
    ...
    /**
     * Constructor for a given TapIn object with a delay time specified by a UGen,
     * using the specified delay mode.
     * 
     * @param ac        The audio context.
     * @param ti        The TapIn from which to draw the delayed signal.
     * @param mode      The delay mode; see {@link #setMode(InterpolationType)}.
    ...
    public void calculateBuffer() {
        ...
        if (delayUGen == null) {
            ...
            case LINEAR:
                ...
                break;
            case ALLPASS:
                lastY = ti.fillBufferAllpass(bufOut[0], sampDelayAPInt, g, lastY);
                break;
            }
    ...
    /**
     * Gets the delay UGen, if there is one. Returns <code>null</code> if delay time
     * is set to a static float.
     * 
     * @return This object instance.
     */
