...
/**
 * An abstract UGen that waits for a specified amount of time before
 * "triggering" (executing some code). The {@link #trigger()} method is called
 * when the delay time has elapsed. DelayEvent is the base class for
 * {@link DelayTrigger} (used to send Bead messages) and {@link DelayData} (used
 * to send DataBeads).
 * 
...
public abstract class DelayEvent extends UGen {
    ...
    /**
     * Whether to wait until after the frame in which the delay time has expired.
     */
     ...
     * receiver. By default, the object will be triggered at the beginning of the
    ...
    /**
     * Instantiates a new DelayEvent with the specified millisecond delay and
     * receiver. <code>triggerAfter</code> indicates whether the object is triggered
     * at the beginning of the frame in which the delay time elapses (
     * <code>false</code>), or after (<code>true</code>).
     * 
     * @param context      The audio context.
     * @param delay        The delay in milliseconds.
     * @param triggerAfter Whether the object fires just before or just after the
     *                     delay time expires.
     */
    ...
    /**
     * Called when the delay time has elapsed. Implement this method with code to be
     ...
     * after the delay time expires; returns <code>false</code> if it is triggered
     * during the frame in which the delay time expires.
     * 
    ...
    /**
     * Sets whether the Delay event fires during the frame in which the delay time
     * expires (<code>false</code>, the default), or the frame after (
     * <code>true</code>).
     * 
