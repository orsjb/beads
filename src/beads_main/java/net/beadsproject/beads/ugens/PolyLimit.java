...
/**
 * The Class PolyLimit is a mixer which can be used to keep a limit on the
 * number of UGens connected to it. An upper limit is given. If a new UGen is
 * added but this takes the number of connected UGens over that upper limit then
 * the oldest connected UGen is dropped in order to allow the new UGen to be
 * connected.
 *
 */
public class PolyLimit extends UGen {
    ...
    /**
     * Overrides {@link UGen#addInput(UGen)} such that if a new UGen pushes the
     * total number of connected UGens above the upper limit, the oldest UGen is
     * removed.
     */
    ...
    /**
     * Determines whether steal mode is true. This means that old sounds are
     * replaced by new ones. If false, new sounds are refused.
     * 
     * @return
     */
    ...
    /**
     * Sets whether steal mode is true. This means that old sounds are replaced by
     * new ones. If false, new sounds are refused.
     * 
     * @param steal
     */
