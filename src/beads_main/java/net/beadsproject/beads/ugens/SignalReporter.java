...
public class SignalReporter extends UGen {
    ...
    /**
     * Called regularly according to the interval length; by default, it outputs a
     * report (<code>System.out.println</code>)that includes the name, report #, and
     * first value of the current input signal frame. This can be overridden to
    ...
    public void notify(long count, float value) {
        System.out.println("SignalReporter " + name + ", report #" + count + ": " + value);
    }
