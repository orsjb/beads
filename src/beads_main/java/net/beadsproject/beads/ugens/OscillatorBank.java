...
/**
 * An OscillatorBank sums the output of a set of oscillators with assignable
 * frequencies and amplitudes. The frequencies and amplitudes of the set of
 * oscillators can be assigned using arrays.
 *
 * @author ollie
 */
public class OscillatorBank extends UGen {
    ...
    /**
     * The array of increment rates of individual oscillators, given their
     * frequencies.
     */
    ...
    /**
     * Sets the frequencies and gains of all oscillators from an array
     * freqsGains[][] where freqsGains[i][0] gives the ith frequency, and
     * freqsGains[i][1] gives the ith gain. This is the format generated by the
     * SpectralPeaks FeatureExtractor.
     * 
     * @param freqsGains
     */
