...
public class Throughput extends UGen {
    ...
    /**
     * Constructor for a one-channel Throughput using the defualt audio context.
     */
    public Throughput() {
    ...
    /**
     * Constructor for a Throughput with the specified number of channels, using the
     * specified audio context.
     * 
     * @param context  The audio context.
