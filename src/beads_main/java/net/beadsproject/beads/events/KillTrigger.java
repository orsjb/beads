...
/**
 * Use KillTrigger to cause a specific {@link Bead} to be killed
 * ({@link Bead#kill()}) in response to a specific event.
 */
public class KillTrigger extends Bead {
    ...
    /**
     * Instantiates a new KillTrigger which will stop the given {@link Bead} when
     * triggered.
     * 
