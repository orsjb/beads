...
/**
 * FeatureExtractor is an abstract base class for classes that perform some kind
 * of analysis on incoming data. Both the incoming data (P) and the generated
 * data (R) are generic types. Implementing classes use the method
 * {@link #process} to process data.
 * 
 * @author ollie
 */
public abstract class FeatureExtractor<R, P> extends Bead {
    ...
    /**
     * A set of FeatureExtractors that this FeatureExtractor forwards its feature
     * data to.
     */
    private ArrayList<FeatureExtractor<?, R>> featureExtractorListeners;

    /**
     * Instantiates a new FeatureExtractor. This constructor names the
     * FeatureExtractor with the name of the implementing class.
     */
    ...
    /**
     * Subclasses should call this at end of their process() method to forward
     * features to listeners.
     * 
     * @param startTime Start Time
     * @param endTime   end time
     */
    ...
    /**
     * Gets the feature descriptions. Implementing classes should make sure that
     * this array has meaningful content.
     * 
