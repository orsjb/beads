...
/**
 * An AudioSegmenter slices incoming audio data into chunks, as implemented by
 * subclasses, usually in their calculateBuffer method, and then notifies any
 * FeatureExtractors or other SegmentListeners that are listening.
 * 
 * @author ollie
 *
 */
public abstract class AudioSegmenter extends UGen implements SegmentMaker {
    ...
    /**
     * Called by instantiations of Segmenter, to indicate that a new segment has
     * been created.
     * 
     * @param startTime double indicating the start time of the data chunk in
     *                  milliseconds.
     * @param endTime   double indicating the end time of the data chunk in
     *                  milliseconds.
