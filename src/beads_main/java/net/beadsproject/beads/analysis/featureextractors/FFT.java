...
/**
 * FFT performs a Fast Fourier Transform and forwards the complex data to any
 * listeners. The complex data is a float of the form float[2][frameSize], with
 * real and imaginary parts stored respectively.
 *
 */
public class FFT extends FeatureExtractor<float[][], float[]> {
    ...
    /**
     * Returns the average bin number corresponding to a particular frequency. Note:
     * This function returns a float. Take the Math.round() of the returned value to
     * get an integral bin number.
     * 
     * @param samplingFrequency The Sampling Frequency of the AudioContext
    ...
    /*
     * All of the code below this line is taken from Holger Crysandt's MPEG7AudioEnc
     * project. See http://mpeg7audioenc.sourceforge.net/copyright.html for license
     * and copyright.
     */
