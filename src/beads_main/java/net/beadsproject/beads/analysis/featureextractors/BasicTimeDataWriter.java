...
/**
 * BasicTimeDataWriter grabs forwarded feature data and prints it to a file in a
 * simple format. Each line contains the running time of the AC and a set of
 * features at that timestep. Each individual feature is separated by
 * whitespace.
 */
public class BasicTimeDataWriter<T> extends FeatureExtractor<Object, T> {
     ...
     * 
     * @see
     * net.beadsproject.beads.analysis.FeatureExtractor#process(java.lang.Object)
     */
    @Override
