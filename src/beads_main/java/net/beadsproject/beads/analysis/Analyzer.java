...
/**
 * The Class Analyzer sets up a quick'n'easy audio analysis chain which can then
 * be plugged into a realtime or non-realtime audio stream. Tell the Analyzer
