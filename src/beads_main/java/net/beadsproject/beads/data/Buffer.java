...
/**
 * A Buffer stores a one-dimensional buffer of floats for use as a wavetable or
 * a window. Buffer does not perform any interpolation in this version, you
 * should just make sure your buffer is high-res enough for what you need. Could
 * add interpolation easily if needed.
 *
...
public class Buffer implements Serializable {
    ...
    /**
     * A static storage area for common buffers, such as a sine wave. Used by
     * {@link BufferFactory} to keep track of common buffers.
     */
     ...
     * start, 1 = end). Uses linear interpolation.
     * 
    ...
    /**
     * Returns the value of the buffer at a specific index. If index is outside the
     * range, then it is clipped to the ends.
     * 
