...
public class DataBead extends Bead implements Map<String, Object> {
     ...
     * Other properties may be added with {@link #put(String, Object) put()}.
     * 
    ...
    /**
     * Creates a DataBead instance with properties specified by a String array that
     * are set to corresponding values specified by an Object array. Other
    ...
    /**
     * Creates a DataBead instance that uses a Map (a Hashtable, for example) for
     * its properties. (This does not copy the input Map, so any changes to it will
     * change the properties of the DataBead!) Other properties may be added with
     * {@link #put(String, Object) put()}.
     * 
    ...
    /**
     * Creates a new DataBead from an interleaved series of key-value pairs, which
     * must be in the form (String, Object, String, Object...), etc.
     * 
    ...
    /**
     * If the input message is a DataBead, this adds the properties from the message
     * Bead to this one. (Equivalent to {@link #putAll(DataBead)} .)
     */
    ...
    /**
     * Adds an interleaved series of key-value pairs to the DataBead, which must be
     * in the form (String, Object, String, Object...), etc.
     * 
    ...
    /**
     * Uses the parameters stored by this DataBead, this method configures the given
     * object by using reflection to discover appropriate setter methods. For
     * example, if the object has a method <code>setX(float f)</code> then the
     * key-value pair &lt;String "x", float 0.5f&gt; will be used to invoke this
    ...
    /**
     * Gets a float representation of the specified property; returns the specified
     * default value if that property doesn't exist or cannot be cast as a float.
     * <p>
     * This method is a useful way to update <code>float</code> parameters in a
     * class:
     * <p>
     * <code>float param = startval;</code><br>
     * ...<br>
    ...
    /**
     * Returns the UGen value for the specified key. If the value stored at the key
     * is not a UGen, it returns <code>null</code>.
     * 
     * @param key The key.
     ...
     * some other type, the method will return a new float array filled with values
     * converted to float; an array of doubles, for instance, will be recast as
     * floats. Single numbers will be returned as a one-element float array. If no
     * array can be formed from the stored value, or if there is no stored value,
    ...
    /**
     * Gets an array of UGens from the value stored with the specified key. If the
     * value is a UGen object (not an array), the method returns a new one-element
     * UGen array with the value stored in it. If the value is empty, or not a UGen
     * array or UGen, the method returns <code>null</code>.
     * 
     * @param key The key.
    ...
    /**
     * Creates a new DataBead that combines properties from both input DataBeads. If
     * the same key exists in both, the value from the first one is used.
     * 
