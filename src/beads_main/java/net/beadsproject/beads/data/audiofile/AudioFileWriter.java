...
/**
 * Implementing this interface indicates support for 'one-shot' writing of an
 * audio file. That is, an entire audio file can be opened, written from a
...
public interface AudioFileWriter {
     ...
     * @param saf      - a SampleAudioFormat object specifying the attributes of the
     *                 sample data to be written. Can be NULL, in which case default
     *                 values will be used.
     *
     */
    void writeAudioFile(float[][] data, String filename, AudioFileType type, SampleAudioFormat saf)
