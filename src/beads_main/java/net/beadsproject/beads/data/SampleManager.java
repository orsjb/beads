...
/**
 * SampleManager provides a static repository for {@link Sample} data and
 * provides methods to organise samples into groups.
 *
 */
public class SampleManager {
    ...
    /**
     * List of group names mapped to group directories, groups only in this list if
     * from same directory.
     */
    ...
    /**
     * Returns a new Sample from the given filename. If the Sample has already been
     * loaded, it will not be loaded again, but will simply be retrieved from the
     * static repository.
     * 
    ...
    /**
     * Adds a sample by name to the sample list. This lets you load samples with a
     * different buffering regime.
     * 
     * @param name
     * @param sample
     */
    ...
    /**
     * Like {@link SampleManager#sample(String)} but with the option to specify the
     * name with which this {@link Sample} is indexed.
     * 
    ...
    /**
     * Generates a new group with the given group name and a string that specifies
     * where to load samples to be added to the group. The string is interpreted
     * firstly as a URL, and if that fails, as a folder path.
     * 
     * @param groupName  the group name.
    ...
    /**
     * Generates a new group with the given group name and a string that specifies
     * where to load samples to be added to the group, and also limits the number of
     * items loaded from the folder to maxItems. The string is interpreted firstly
     * as a URL, and if that fails, as a folder path.
     * 
     * @param groupName  the group name.
     * @param folderName the folder address (URL or file path).
    ...
    /**
     * Generates a new group with the given group name and a list of file names to
    ...
    /**
     * Generates a new group with the given group name and a list of file names to
     * be added to the group, with number of elements loaded limited to maxItems.
     * 
     * @param groupName    the group name.
     * @param fileNameList the file name list.
     * @param maxItems     number of items to limit to.
    ...
    /**
     * Add a new list of Samples to the specified group. Create the group if it
     * doesn't exist.
     * 
     * @param group      the group to add to.
    ...
    /**
     * Gets the Sample at the specified index from the specified group. If index is
     * greater than the size of the group then the value index % sizeOfGroup is
     * used.
     * 
     * @param groupName the group name.
     ...
     * file names of {@link Sample}s loaded so far. Useful if you need to gather all
     * of your sample data into one place using a script. Puts all file names in
     * double quotes.
     * 
     ...
     * relative to sourceRootDir. This only applies to {@link Sample}s that were
     * loaded from a position below sourceRootDir.
     * 
     * @param sourceRootDir root that you want to transfer from
     * @param destRootDir   place you want to transfer to
     * @param force         set to true to force overwrite existing files - take
     *                      care!
     */
     ...
     * group changes using
     * {@link SampleManager#addGroupListener(SampleGroupListener)}.
     * 
     * @author ollie
     *
     */
