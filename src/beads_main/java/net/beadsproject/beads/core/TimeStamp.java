...
/**
 * TimeStamps store time with respect to the current {@link AudioContext}.
...
public class TimeStamp {
    ...
    /**
     * Instantiates a new TimeStamp with the given time step, context and buffer
     * index. Use {@link AudioContext#generateTimeStamp(int)} to generate a
    ...
    /**
     * Returns the time stamp formatted as timeStep-index, useful for debugging
     * purposes.
     */
