...
/**
 * Encapsulates data bout audio format for IO. Also has number of input
 * channels, in addition to the standard number of channels, so this defines the
 * format for an input/output system.
 * 
...
public class IOAudioFormat {
    ...
    public IOAudioFormat(float sampleRate, int bitDepth, int inputs, int outputs, boolean signed, boolean bigEndian) {
