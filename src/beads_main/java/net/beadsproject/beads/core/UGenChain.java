...
public class UGenChain extends UGen {
     ...
     */
    public void drawFromChainInput(int chainInputIndex, UGen targetUGen, int targetInputIndex) {
     ...
     * @param chainOutputIndex  The Chain output.
     * @param sourceUGen        The source UGen.
     * @param sourceOutputIndex The output of the source UGen to add to the Chain
     *                          output.
     */
    public void addToChainOutput(int chainOutputIndex, UGen sourceUGen, int sourceOutputIndex) {
