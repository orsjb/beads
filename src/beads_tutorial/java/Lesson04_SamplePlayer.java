...
public class Lesson04_SamplePlayer {
    ...
    public static void main(String[] args) {
         ...
         * 
         * The first line gives you a way to choose the audio file. The (commented,
         * optional) second line allows you to stream the audio rather than loading it
         * all at once. The third line creates a sample player and loads in the Sample.
        ...
        player.setInterpolationType(InterpolationType.LINEAR);
        /*
         * And as before...
         */
        Gain g = new Gain(2, 0.1f);
        g.addInput(player);
        ac.out.addInput(g);
        ac.start();
    }
