...
public class Lesson07_Music {
    ...
    public static void main(String[] args) {
        ...
        /*
         * In this example a Clock is used to trigger events. We do this by adding a
         * listener to the Clock (which is of type Bead).
         * 
         * The Bead is made on-the-fly. All we have to do is to give the Bead a callback
         * method to make notes.
         * 
         * This example is more sophisticated than the previous ones. It uses nested
         * code.
         */
