...
public class AudioContext {
	...
	public AudioContext(int bufferSize) {
        ...
        classes.add("net.beadsproject.beads.core.io.JavaSoundAudioIO");
        classes.add("org.jaudiolibs.beads.AudioServerIO$JavaSound");
        classes.add("net.beadsproject.beads.core.io.AndroidSoundAudioIO");
        for (String s : classes) {
            try {
                Class javaSoundAudioIOClass = Class.forName(s);		//alt choice is org.jaudiolibs.beads.AudioServerIO$JavaSound.
                ...
                System.out.println("AudioContext : warning : unable to find AudioIO: " + s);
            }
