...
public class WavFileReaderWriter implements AudioFileReader, AudioFileWriter {
	...
	public float[][] readAudioFile(String filename) throws IOException, OperationUnsupportedException, FileFormatException {
        ...
        return readAudioFileBase(fileInputStream);
	}
	 ...
	 */
	@Override
	public float[][] readAudioFile(File file) throws IOException, OperationUnsupportedException, FileFormatException {
	 ...
	 */
	@Override
	public float[][] readAudioFile(InputStream inputStream) throws IOException, OperationUnsupportedException, FileFormatException {
		return readAudioFileBase(inputStream);
	}

    private float[][] readAudioFileBase(InputStream fileInputStream) throws IOException, OperationUnsupportedException, FileFormatException {
...
//		iStream = new FileInputStream(file);
        ...
        if (file != null) {
            ...
            System.out.println("The file isn't available, so chunk size can't be tested.");
        }
